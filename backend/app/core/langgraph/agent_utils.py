...
BUSINESS_DOMAIN_KEYWORDS = [
    ...
    "инструкци", "регламент", "протокол", "спецификаци",
    # Бизнес-процессы
    "склад", "товар", "логистик", "поставк", "заказ", "закупк",
    "продаж", "реализаци", "инвентаризаци",
    # ERP и учёт
    "ERP", "CRM", "SAP", "1С", "учёт", "учет", "бухгалтер",
    "налог", "инвойс", "платёж", "платеж",
    # ЭДО и документооборот
    "УПД", "ЭДО", "электрон", "подпис",
    # Производство и качество
    "производств", "брак", "качество", "сертификат",
    "лаборатор", "измерени", "контрол",
    # Общие бизнес-термины
    "бизнес", "компани", "предприяти", "организаци",
    "отдел", "департамент", "сотрудник", "клиент",
    "контрагент", "партнёр", "партнер", "подрядчик",
    "бюджет", "финанс", "расход", "доход", "себестоимость",
    # Технические термины
    "чертёж", "чертеж", "схем", "технологи", "оборудовани",
    "стандарт", "норма", "ТУ", "ГОСТ",
    # Базовые
    "работа", "задач", "проект", "цель", "план"
]
